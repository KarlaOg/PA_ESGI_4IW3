    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('field', ChoiceType::class, [
                ...
                'required' => false,
                'choices' => array(
                    'Youtubeur / Blogueuse ' => 'Youtubeur / Blogueuse ',
                    'Blogueur / Blogeuse' => 'Blogueur / Blogeuse',
                    'Mannequin' => 'Mannequin',
                    'Influenceur / Influenceuse' => 'Influenceur / Influenceuse',
                    'Créateur de contenue' => 'Créateur de contenue',
                    'Sportif / Sportive' => 'Sportif / Sportive',
                    'Mode' => 'Mode',
                    'Cusine, recette' => 'Cusine, recette',
                    'Chanteur / Chanteuse' => 'Chanteur / Chanteuse',
                    'Actrice / Acteur' => 'Actrice / Acteur',
                ),
                'multiple'  => true,
                'required' => true,
                'expanded' => true,
