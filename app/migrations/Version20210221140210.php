 ...
 */
final class Version20210221140210 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE brand ADD name VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE user_account ALTER updated_at SET DEFAULT \'2021-02-21 14:01:33.920238\'');
    }
}
