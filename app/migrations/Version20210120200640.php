 ...
 */
final class Version20210120200640 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE brand (id INT NOT NULL, user_id_id INT DEFAULT NULL, application_id INT DEFAULT NULL, domain TEXT NOT NULL, type_brand BOOLEAN NOT NULL, siret INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE influencer (id INT NOT NULL, user_id_id INT DEFAULT NULL, type BOOLEAN NOT NULL, social_network TEXT NOT NULL, siret INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE brand ADD CONSTRAINT FK_1C52F9589D86650F FOREIGN KEY (user_id_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE influencer ADD CONSTRAINT FK_3D9F8CA39D86650F FOREIGN KEY (user_id_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
