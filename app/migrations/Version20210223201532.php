 ...
 */
final class Version20210223201532 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE influencer (id INT NOT NULL, user_id_id INT DEFAULT NULL, social_network TEXT DEFAULT NULL, siret INT DEFAULT NULL, type TEXT NOT NULL, username VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
