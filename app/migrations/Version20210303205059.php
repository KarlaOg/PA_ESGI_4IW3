 ...
 */
final class Version20210303205059 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE brand (id INT NOT NULL, user_id_id INT DEFAULT NULL, siret INT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, social_network TEXT DEFAULT NULL, domaine JSON DEFAULT NULL, username VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, profile_photo VARCHAR(255) DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'NOW()\', PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE influencer (id INT NOT NULL, user_id_id INT DEFAULT NULL, social_network TEXT DEFAULT NULL, siret INT DEFAULT NULL, username VARCHAR(255) DEFAULT NULL, type JSON DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, profile_photo VARCHAR(255) DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'NOW()\', PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_account (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, age TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
