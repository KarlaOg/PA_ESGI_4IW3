 ...
 */
final class Version20210226133332 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE brand DROP CONSTRAINT fk_1c52f95868b02f7f');
        $this->addSql('DROP INDEX uniq_1c52f95868b02f7f');
        $this->addSql('ALTER TABLE brand DROP userbrand_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_account ALTER updated_at SET DEFAULT \'2021-02-26 13:30:34.872789\'');
        $this->addSql('ALTER TABLE brand ADD userbrand_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE brand ADD CONSTRAINT fk_1c52f95868b02f7f FOREIGN KEY (userbrand_id) REFERENCES user_account (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE UNIQUE INDEX uniq_1c52f95868b02f7f ON brand (userbrand_id)');
    }
}
