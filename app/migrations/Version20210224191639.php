 ...
 */
final class Version20210224191639 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE brand DROP CONSTRAINT fk_1c52f958a76ed395');
        $this->addSql('DROP INDEX idx_1c52f958a76ed395');
        $this->addSql('ALTER TABLE brand RENAME COLUMN user_id TO user_id_id');
        ...
        $this->addSql('ALTER TABLE influencer ADD user_id_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_1C52F9589D86650F');
        $this->addSql('ALTER TABLE brand RENAME COLUMN user_id_id TO user_id');
        $this->addSql('ALTER TABLE brand ADD CONSTRAINT fk_1c52f958a76ed395 FOREIGN KEY (user_id) REFERENCES user_account (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE influencer DROP user_id_id');
        $this->addSql('ALTER TABLE user_account ALTER updated_at SET DEFAULT \'2021-02-24 19:12:47.460776\'');
    }
}
