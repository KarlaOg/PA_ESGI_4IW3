 ...
 */
final class Version20210305231514 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE influencer ADD name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE brand ALTER updated_at SET DEFAULT \'2021-03-05 23:13:58.160134\'');
        $this->addSql('ALTER TABLE influencer DROP name');
        $this->addSql('ALTER TABLE influencer ALTER updated_at SET DEFAULT \'2021-03-05 23:13:58.16414\'');
    }
}
