 ...
 */
final class Version20210221200035 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE brand (id INT NOT NULL, user_id_id INT DEFAULT NULL, application_id INT DEFAULT NULL, domain TEXT DEFAULT NULL, type_brand BOOLEAN DEFAULT NULL, siret INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE influencer (id INT NOT NULL, user_id_id INT DEFAULT NULL, social_network TEXT DEFAULT NULL, siret INT DEFAULT NULL, PRIMARY KEY(id))');
