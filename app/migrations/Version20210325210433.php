 ...
 */
final class Version20210325210433 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE brand (id INT NOT NULL, user_id_id INT DEFAULT NULL, siret INT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, social_network TEXT DEFAULT NULL, field JSON DEFAULT NULL, username VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, profile_photo VARCHAR(255) DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'NOW()\', PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_1C52F9589D86650F ON brand (user_id_id)');
        $this->addSql('COMMENT ON COLUMN brand.social_network IS \'(DC2Type:array)\'');
        ...
        $this->addSql('CREATE TABLE influencer (id INT NOT NULL, user_id_id INT DEFAULT NULL, social_network TEXT DEFAULT NULL, siret INT DEFAULT NULL, username VARCHAR(255) DEFAULT NULL, type JSON DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, profile_photo VARCHAR(255) DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'NOW()\', name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE offer (id INT NOT NULL, brand_id_id INT DEFAULT NULL, application_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date_creation TIMESTAMP(0) WITH TIME ZONE NOT NULL, date_start TIMESTAMP(0) WITH TIME ZONE NOT NULL, date_end TIMESTAMP(0) WITH TIME ZONE NOT NULL, status VARCHAR(255) NOT NULL, field JSON NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_account (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, age TIMESTAMP(0) WITH TIME ZONE NOT NULL, status JSON NOT NULL, PRIMARY KEY(id))');
