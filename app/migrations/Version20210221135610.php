 ...
 */
final class Version20210221135610 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE brand (id INT NOT NULL, user_id_id INT DEFAULT NULL, application_id INT DEFAULT NULL, domain TEXT DEFAULT NULL, type_brand BOOLEAN DEFAULT NULL, siret INT DEFAULT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
