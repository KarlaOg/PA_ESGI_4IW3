 ...
 */
final class Version20210708185004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE brand (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, siret VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, social_network LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', field JSON DEFAULT NULL, username VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, profile_photo VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_1C52F95826E94372 (siret), INDEX IDX_1C52F958A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE channel (id INT AUTO_INCREMENT NOT NULL, user1_id INT DEFAULT NULL, user2_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_A2F98E4756AE248B (user1_id), INDEX IDX_A2F98E47441B8B65 (user2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE chat (id INT AUTO_INCREMENT NOT NULL, channel_id INT DEFAULT NULL, sender_id INT DEFAULT NULL, time DATETIME NOT NULL, message VARCHAR(255) NOT NULL, INDEX IDX_659DF2AA72F5A1AA (channel_id), INDEX IDX_659DF2AAF624B39D (sender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE influencer (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, social_network LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', siret VARCHAR(255) DEFAULT NULL, username VARCHAR(255) DEFAULT NULL, type JSON DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, profile_photo VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_3D9F8CA326E94372 (siret), INDEX IDX_3D9F8CA3A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
