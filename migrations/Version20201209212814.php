 ...
 */
final class Version20201209212814 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE application (id INT AUTO_INCREMENT NOT NULL, status TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE brand (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, application_id INT DEFAULT NULL, domain LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', type_brand TINYINT(1) NOT NULL, siret INT NOT NULL, INDEX IDX_1C52F9589D86650F (user_id_id), INDEX IDX_1C52F9583E030ACD (application_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE chat (id INT AUTO_INCREMENT NOT NULL, sender_id INT NOT NULL, receiver_id INT NOT NULL, time DATETIME NOT NULL, message VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE influencer (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, type TINYINT(1) NOT NULL, social_network LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', siret INT DEFAULT NULL, INDEX IDX_3D9F8CA39D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, brand_id_id INT DEFAULT NULL, application_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, decription VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, status TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_29D6873E24BD5740 (brand_id_id), INDEX IDX_29D6873E3E030ACD (application_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, age DATETIME NOT NULL, password VARCHAR(255) NOT NULL, type JSON NOT NULL, token VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE brand ADD CONSTRAINT FK_1C52F9583E030ACD FOREIGN KEY (application_id) REFERENCES application (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE brand DROP FOREIGN KEY FK_1C52F9583E030ACD');
